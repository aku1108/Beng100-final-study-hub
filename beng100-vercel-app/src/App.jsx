...
const FINALS = [
  {
    "id": "2025",
    "title": "Practice Final Version A — Spring 2025 exact PDF wording",
    "duration": 10800,
    "questions": [
      {
        "id": "25q1",
...
d) Find E[Z] and Var[Z]`,
      ...
      },
      {
        ...
        "points": 11,
        "topic": "Random sum",
        "prompt": `Problem 3 [11 points]. Let N be the random number of action potentials (spikes) generated by a neuron in a given time interval. Suppose N~Geometric(p), where 0<p<1 is a known firing rate.

Let X_i be the duration of the refractory period following the ith spike, for i=1,2,...,N. Assume the X_i's are independent of each other and also independent of N. Further, assume X_i~Uniform(0,a), where a>0 is known. Let Y be the sum of the durations of the refractory period:
...
Find E[Y] and Var[Y].`,
      ...
      },
      {
        ...
        "prompt": "Problem 4 [11 points]. Let X~N(mu=0,sigma^2=1) be a standard normal random variable, and Y=X^2. Use the method of transformations to derive the probability density function f_Y(y) for y>=0. Express your final answer in simplified symbolic form. You may leave constants such as sqrt(2pi) and expressions like e^{-y/2} unevaluated.",
        "keywords": [
          "sqrt",
          "-sqrt",
          "1/sqrt",
...
Where a in R and a>0. Given that Y=|X|, derive the moment generating function of Y.`,
        "keywords": [
          "exponential",
          "1/a",
          "1/(1-at)",
...
Provided that Y|X~Exponential(X), find the covariance of X and Y. Based on the covariance, interpret the relationship between X and Y. As the value of X increases, does the expected value of Y tend to increase, decrease, or remain constant? Hint: Consider using the law of total variance and the law of total probability to solve this problem. For calculation simplicity please consider log_e 3 = ln 3 ≈ 1.10.`,
      ...
      },
      {
        ...
        "points": 11,
        "topic": "MLE Poisson",
        "prompt": "Problem 8 [11 points]. Given that X_1,X_2,X_3,...,X_n is a random sample from X~Poisson(lambda), derive the maximum likelihood estimator for lambda. Hint: consider using the log likelihood function.",
        "keywords": [
          "lambda hat",
          "bar",
          "sum",
      ...
      },
      {
        ...
        "points": 11,
        "topic": "Bias",
        "prompt": `Problem 9 [11 points]. In a bioengineering study of calcium signaling dynamics, a researcher records the peak intracellular calcium concentration in response to repeated stimuli across n cells using a fluorescent indicator. Let X_1,X_2,X_3,...,X_n denote the measured peak calcium amplitudes (in microM) from each cell. Assume the X_i's are independent and identically distributed with unknown mean mu and unknown variance sigma^2. The researcher is interested in estimating the squared mean amplitude theta=mu^2, which is proportional to the power of the calcium response across the cell population. They define the estimator:

Theta_hat=(Xbar)^2=(1/n sum_{i=1}^n X_i)^2

to estimate theta. Calculate the bias of Theta_hat for estimating theta. Does the estimator tend to underestimate, overestimate, or provide an unbiased estimate?`,
        "keywords": [
          "sigma^2/n",
          "positive",
          "overestimate",
...
function TimedFinalTab() {
  ...
  return <div style={S.content}>
    <div style={S.alert(C.red,C.redBg)}>Real final target: 10 problems, 110 points, 95+ for A+. Spring 2025 uses exact PDF-style wording; Spring 2024 and 2023 are condensed practice wording. Use this timed mode to practice finishing clean derivations in 3 hours, then grade with the revealed solutions because automatic scoring is keyword/rubric-based.</div>
